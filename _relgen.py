...
TOOLS = {
 ...
 'gif-maker':     ('🎞️','GIF 만들기','사진 여러 장으로 움짤 애니메이션',
                   '사진 여러 장을 이어 붙여 움직이는 GIF를 만듭니다. 순서와 프레임 간격, 반복 여부, 출력 크기를 정하고 미리보기로 확인한 뒤 저장합니다.'),
...
CATS = [
 ('이미지 편집', '사진을 다루는 도구입니다. 전부 브라우저 안에서 처리되고 업로드가 없어서, 얼굴이 나온 사진이나 공개 전 자료도 안심하고 올릴 수 있습니다.',
  ['remove-bg','id-photo','resize','convert','image-compress','watermark','gif-maker']),
...
REL = {
 ...
 'watermark':     ['image-compress','resize','remove-bg'],
 'gif-maker':     ['resize','image-compress','convert'],
...
CALC = {'salary', 'severance', 'holiday-pay', 'annual-leave', 'unemployment',
        ...
        'rent-convert', 'deposit', 'electricity', 'fuel-cost',
